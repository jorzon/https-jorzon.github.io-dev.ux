...
if (rute.includes("about")) {
  $(
    ".page .page1__header .section1__main .item__list .item ul li:nth-child(2)"
  ).addClass("active");
  $(
    ".page .page1__header .section2__main .item__list .item ul li:nth-child(2)"
  ).addClass("active");
} else {
  $(
    ".page .page1__header .section1__main .item__list .item ul li:nth-child(1)"
  ).addClass("active");
  $(
    ".page .page1__header .section2__main .item__list .item ul li:nth-child(1)"
  ).addClass("active");
}
